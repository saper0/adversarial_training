...
import os
from typing import Any, Callable, Dict, Iterator, List, Optional, Union, Tuple, Iterable, Mapping
...
from robust_diffusion.models import create_model, MODEL_TYPE
...
class Storage():
    ...
    def find_artifacts_gen(self, artifact_type: str, match_condition: Dict[str, Any],
                       return_documents_only=False) -> Iterator[Dict[str, Any]]:
        """Find all artifacts matching the defined parameters.
